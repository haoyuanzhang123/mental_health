...
# install.packages(c("tidyverse", "lubridate", "bnlearn". "visNetwork", "rbmn","Rgraphviz", "gRain"), dependencies = TRUE)
library(tidyverse)
library(lubridate)
library(bnlearn)
library(visNetwork)
...
dataRaw <- read_csv("C:/Users/Haoyuan/Google Drive/Zhang Haoyuan/dummy2.csv")
dataRaw <- dataRaw[,-1]
dataRaw <- dataRaw[1:2000,]
# discretise variable age into categories with a 10-age bandwidth
